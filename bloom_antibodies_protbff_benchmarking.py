...
Usage:
    python evaluate_both_models.py \
        --prosst_model_dir /path/to/prosst_models/ \
        --prosst_cache_path /path/to/prosst_cache.npz \
        --esm2_model_dir /path/to/esm2_models/ \
        --esm2_cache_path /path/to/esm2_cache.npz \
